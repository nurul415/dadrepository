...
public class ServerTranslateFrame extends JFrame
{
	...
	private JTextArea translateRequestStatus;
	...
	public ServerTranslateFrame () 
	{
		...
		// Row, Column
		this.translateRequestStatus  = new JTextArea(20, 70);
	...
	private JPanel getRequestStatusPanel () 
	{
		...
		translateRequestStatus.setText("\n > Server is running");
		translateRequestStatus.setEditable(false);
		
		// Styling the request text
		translateRequestStatus.setFont(new Font("Courier", Font.PLAIN, 15));


		// Add component to panel
		panel.add(translateRequestStatus);
	...
	public void updateRequestStatus (String status) {
		...
		String currentText = this.translateRequestStatus.getText();
		translateRequestStatus.setEditable(true);
		
		// Display the latest status on top
		status += "\n > " + currentText;
		this.translateRequestStatus.setText(status);
		translateRequestStatus.setEditable(false);
	}
